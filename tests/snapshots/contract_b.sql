WITH "aggregated" AS (
  SELECT
    ...
    SUM("t0"."revenue") FILTER (WHERE CAST("t1"."fiscal_year" AS VARCHAR) = '2025') AS "m0",
    SUM("t0"."revenue") FILTER (WHERE CAST("t1"."fiscal_year" AS VARCHAR) = '2026') AS "m1"
  ...
  WHERE CAST("t1"."fiscal_year" AS VARCHAR) IN ('2025', '2026')
